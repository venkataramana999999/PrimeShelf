                ...
                <div className="page-body-wrapper sidebar-icon">
                    ...
                    <div className="card" style={{padding:'10px'}} >
                        ...
                        <div style={{ display: 'flex', marginTop: '15px', flexDirection: 'column', textAlign: 'justify' }}>
                            <div>
                                <h6 style={{ marginTop: '3px', paddingLeft: "10px", color: 'gray' }}>Select Campaign <span style={{ color: 'red' }}>*</span></h6>
                            </div>
                            <div style={{ display: 'flex' }}>
                                ...
                                <div className="col-md-3" style={{ marginLeft: '20px' }}>
                                    <label></label>
                                    <button className="btn custom_btn " style={{ width: '80%', height: '70px' }}><i className="fa fa-bullhorn"></i> Create <br />Campaign </button>
                                </div>

                            </div>
                            <hr className="mt-3" style={{ margin: '10px' }}></hr>
                            <button type="button" className="btn btn-success ProceedToBooking" style={{ width: '25%', height: '50px', marginLeft: '10px', marginBottom: '10px', marginTop: '20px' }}>Proceed To Booking</button>
                        </div>
